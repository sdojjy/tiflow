...
type DispatchTableResponse struct {
	...
	//	*DispatchTableResponse_BatchAdd
	//	*DispatchTableResponse_BatchRemove
...
type DispatchTableResponse_BatchAdd struct {
	BatchAdd *AddTableResponses `protobuf:"bytes,3,opt,name=batch_add,json=batchAdd,proto3,oneof" json:"batch_add,omitempty"`
}
type DispatchTableResponse_BatchRemove struct {
	BatchRemove *RemoveTableResponses `protobuf:"bytes,4,opt,name=batch_remove,json=batchRemove,proto3,oneof" json:"batch_remove,omitempty"`
}
...
func (*DispatchTableResponse_BatchAdd) isDispatchTableResponse_Response()    {}
func (*DispatchTableResponse_BatchRemove) isDispatchTableResponse_Response() {}
...
func (m *DispatchTableResponse) GetBatchAdd() *AddTableResponses {
	if x, ok := m.GetResponse().(*DispatchTableResponse_BatchAdd); ok {
		return x.BatchAdd
	}
	return nil
}

func (m *DispatchTableResponse) GetBatchRemove() *RemoveTableResponses {
	if x, ok := m.GetResponse().(*DispatchTableResponse_BatchRemove); ok {
		return x.BatchRemove
	}
	return nil
}
...
func (*DispatchTableResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*DispatchTableResponse_BatchAdd)(nil),
		(*DispatchTableResponse_BatchRemove)(nil),
	}
}

type RemoveTableResponses struct {
	Resps []*RemoveTableResponse `protobuf:"bytes,1,rep,name=resps,proto3" json:"resps,omitempty"`
}

func (m *RemoveTableResponses) Reset()         { *m = RemoveTableResponses{} }
func (m *RemoveTableResponses) String() string { return proto.CompactTextString(m) }
func (*RemoveTableResponses) ProtoMessage()    {}
func (*RemoveTableResponses) Descriptor() ([]byte, []int) {
	return fileDescriptor_86eeacbf6ca5b996, []int{8}
}
func (m *RemoveTableResponses) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemoveTableResponses) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemoveTableResponses.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemoveTableResponses) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoveTableResponses.Merge(m, src)
}
func (m *RemoveTableResponses) XXX_Size() int {
	return m.Size()
}
func (m *RemoveTableResponses) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoveTableResponses.DiscardUnknown(m)
}

var xxx_messageInfo_RemoveTableResponses proto.InternalMessageInfo

func (m *RemoveTableResponses) GetResps() []*RemoveTableResponse {
	if m != nil {
		return m.Resps
	}
	return nil
...
type AddTableResponses struct {
	Resps []*AddTableResponse `protobuf:"bytes,1,rep,name=resps,proto3" json:"resps,omitempty"`
}

func (m *AddTableResponses) Reset()         { *m = AddTableResponses{} }
func (m *AddTableResponses) String() string { return proto.CompactTextString(m) }
func (*AddTableResponses) ProtoMessage()    {}
func (*AddTableResponses) Descriptor() ([]byte, []int) {
	return fileDescriptor_86eeacbf6ca5b996, []int{9}
}
func (m *AddTableResponses) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddTableResponses) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddTableResponses.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddTableResponses) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddTableResponses.Merge(m, src)
}
func (m *AddTableResponses) XXX_Size() int {
	return m.Size()
}
func (m *AddTableResponses) XXX_DiscardUnknown() {
	xxx_messageInfo_AddTableResponses.DiscardUnknown(m)
}

var xxx_messageInfo_AddTableResponses proto.InternalMessageInfo

func (m *AddTableResponses) GetResps() []*AddTableResponse {
	if m != nil {
		return m.Resps
	}
	return nil
...
func (*ChangefeedEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_86eeacbf6ca5b996, []int{16}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_86eeacbf6ca5b996, []int{17}
}
...
func (*Message_Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_86eeacbf6ca5b996, []int{17, 0}
}
...
func init() {
	...
	proto.RegisterType((*RemoveTableResponses)(nil), "pingcap.tiflow.cdc.scheduler.schedulepb.RemoveTableResponses")
	proto.RegisterType((*AddTableResponses)(nil), "pingcap.tiflow.cdc.scheduler.schedulepb.AddTableResponses")
...
var fileDescriptor_86eeacbf6ca5b996 = []byte{
	...
	,
}
...
func (m *DispatchTableResponse_BatchAdd) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DispatchTableResponse_BatchAdd) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.BatchAdd != nil {
		{
			size, err := m.BatchAdd.MarshalToSizedBuffer(dAtA[:i])
...
func (m *DispatchTableResponse_BatchRemove) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DispatchTableResponse_BatchRemove) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.BatchRemove != nil {
		{
			size, err := m.BatchRemove.MarshalToSizedBuffer(dAtA[:i])
...
func (m *RemoveTableResponses) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemoveTableResponses) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoveTableResponses) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Resps) > 0 {
		for iNdEx := len(m.Resps) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Resps[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AddTableResponses) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddTableResponses) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddTableResponses) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Heartbeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TableIDs) > 0 {
		dAtA18 := make([]byte, len(m.TableIDs)*10)
		var j17 int
		...
		i = encodeVarintTableSchedule(dAtA, i, uint64(j17))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *DispatchTableResponse_BatchAdd) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DispatchTableResponse_BatchRemove) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemoveTableResponses) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddTableResponses) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DispatchTableResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Response = &DispatchTableResponse_BatchAdd{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchRemove", wireType)
			...
			v := &RemoveTableResponses{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Response = &DispatchTableResponse_BatchRemove{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTableSchedule(dAtA[iNdEx:])
...
func (m *RemoveTableResponses) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemoveTableResponses: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemoveTableResponses: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Resps = append(m.Resps, &RemoveTableResponse{})
...
func (m *AddTableResponses) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddTableResponses: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddTableResponses: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Resps = append(m.Resps, &AddTableResponse{})
			if err := m.Resps[len(m.Resps)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
